...
const Landing: React.FC = () => {
  ...
  const achievements = [
    {
      icon: Star,
      title: "15+ Years",
      description: "Serving the tech community",
    },
    ...
    { icon: Hexagon, title: "100,000+", description: "Members and growing" },
    {
      icon: CalendarClock,
      title: "50+ Events",
      description: "Annually conducted",
    },
  ];
  ...
  const initiatives = [
    {
      ...
      description:
        "An Internship program that connects students with industry professionals for a 3-month learning journey.",
      image: "/DEVCON_intership.png",
    },
    {
      title: "DEVCON Climate Summit",
      description:
        "The flagship gathering of the Philippines' largest tech community, uniting innovators through talks, expos, and hands-on learning.",
      image: "/summit.jpg",
    },
    {
      title: "Code Camp",
      description:
        "Intensive coding bootcamps that prepare participants for the demands of the tech industry.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-devcon-background via-[#2A2F3D] to-[#7E22CE]/80">
      ...
      <section
        ref={heroRef}
        className="px-6 py-32 md:py-36 lg:py-40 max-w-7xl mx-auto transition-all duration-500 opacity-0"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-white/80 text-lg md:text-xl text-justify">
              Start strong with the DEVCON Chapter Officers’ Onboarding Bot —
              your go-to guide for leading a successful chapter. Kickstart your
              journey in tech with DEVCON.
            </p>
            <div className="pt-4">
              <Button
                onClick={handleStartChat}
            ...
            <div className="pt-4">
              <a
                onClick={() => scrollToSection("about")}
                className="text-white/60 hover:text-white underline text-sm transition-colors cursor-pointer"
              >
                  ...
                  <CarouselItem key={i} className="basis-1/3">
                    <Card className="group relative overflow-hidden aspect-video rounded-xl border border-white/5">
                      <CardContent className="p-0 aspect-video">
                        ...
                        />
                        <div className="absolute inset-0 backdrop-blur-sm bg-devcon-purple/40 group-hover:backdrop-blur-0 group-hover:bg-transparent transition-all duration-300"></div>
                      </CardContent>
                    </Card>
                  </CarouselItem>
                ))}
          ...
          {achievements.map((achievement, index) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white group-hover:text-devcon-yellow transition-colors">
                    {achievement.title}
                  </h3>
      ...
      <section
        id="about"
        ref={aboutRef}
        className="px-6 py-24 max-w-7xl mx-auto opacity-0"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            <div className="text-white/80 space-y-4 text-lg text-justify">
              {" "}
              {/* ✅ Added text-justify */}
              <p>
                DevConnect (DEVCON) is the premier organization of professional
                developers in the Philippines. It was founded in 2009 to create
                a sustainable community of developers and innovators across the
                country.
              </p>
              <p>
                For 15 years, we've been building connections between students,
                professionals, and tech companies, fostering knowledge exchange
                and professional growth through various initiatives.
              </p>
              <p>
                Our mission: to create vibrant communities of software
                developers empowered with knowledge, open-source software, and
                opportunities to solve impactful initiatives for the country.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                <h4 className="text-xl font-bold text-devcon-yellow">
                  Our Vision
                </h4>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                ...
                <div className="bg-black/40 backdrop-blur-sm p-4 rounded-xl">
                  <p className="text-white/90 text-lg font-medium">
                    Building the Future of Philippine Tech
                  </p>
                  <p className="text-devcon-yellow font-bold mt-2">
                    Since 2009
                  </p>
                </div>
              </div>
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <p className="text-white/80 text-lg">
            We run various programs and initiatives aimed at educating,
            connecting, and empowering the Filipino developer community. Here
            are some of our flagship initiatives:
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mt-4">
                  <Button
                    variant="ghost"
                    className="px-0 text-devcon-yellow hover:text-devcon-yellow/80 hover:bg-transparent"
                  >
                    Learn more
        ...
        <div className="mt-12 p-6 bg-gradient-to-r from-devcon-yellow/20 to-devcon-purple/20 rounded-xl border border-white/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-white/80 mt-2">
                We're always open to partnerships that help the developer
                community.
              </p>
            </div>
            <Button
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <p className="text-white/80 text-lg">
            DEVCON has established chapters across the Philippines to ensure we
            reach and support developers nationwide. Find your local chapter and
            join our community!
          </p>
        </div>
          ...
          {chapterLocations.map((location) => (
            ...
            >
              <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                <h3 className="text-xl font-bold text-devcon-yellow mb-4">
                  {location.region} Chapters
                </h3>
        ...
        <div className="mt-12 p-6 rounded-xl bg-gradient-to-br from-devcon-background to-devcon-purple/30 border border-white/10">
          <div className="text-center">
            ...
            <p className="text-white/80 mt-2 mb-6">
              Help us expand DEVCON's reach by starting a new chapter.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-white/80">
              Have questions or want to collaborate with us? Reach out to DEVCON
            ...
            <div className="space-y-4 mt-8">
              ...
              <div className="pt-4">
                ...
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="p-3 rounded-full bg-white/10 hover:bg-white/20 text-white hover:text-devcon-yellow transition-colors"
                  >
                    <svg
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-white/60 mt-4 max-w-md">
                DevConnect Philippines (DEVCON) is the premier community of
                developers and innovators in the Philippines.
              </p>
            </div>
            <div className="flex flex-col items-center md:items-end">
              ...
              <div className="flex gap-4 mt-4">
                <a
                  href="#"
                  className="text-white/60 hover:text-devcon-yellow transition-colors"
                >
                  Privacy Policy
                </a>
                <a
